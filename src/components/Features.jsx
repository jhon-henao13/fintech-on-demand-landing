        ...
        >
          {cardsData.map((card, idx) => (
            <motion.div
              ...
              className={`group bg-brand-darkblue hover:bg-brand-violet rounded-2xl text-white flex flex-col justify-between overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 ${
