  ...
  return (
    <section className="bg-white py-16 sm:py-24">
      <div className="max-w-6xl mx-auto px-6">
        ...
        {/* Métricas / KPIs */}
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 text-center mb-16 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {caseStudies.map((card, idx) => (
            <div
              key={idx}
              className="group relative h-[420px] rounded-3xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 flex flex-col justify-between p-7 border border-slate-100"
            >
              ...
              {/* Contenido Inferior (Testimonio / Impacto) */}
